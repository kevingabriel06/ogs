                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
							...
							<!-- Log on to codeastro.com for more projects! -->
                                <strong class="card-title"><h3 align="center">Select Student to Grade</h3></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="gradeForm">
                                        <div class="row">
                                            <input type="hidden" id="id" name="id" class="form-control cc-exp">
                                            <div class="col-6">
                                                <div class="form-group">
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            function initializeDataTable() {
                                ...
                                dataTable = $('#bootstrap-data-table').DataTable({
                                    ...
                                    "serverSide": true,
                                    "ajax": {
                                        "url": "<?php echo site_url('teacher/viewStudents'); ?>",
                                        "type": "POST",
                                        "data": function(data) {
                        ...
                        $(document).on('click', '.add-grade', function() {
                            ...
                            $('#gradeModal input[name="id"]').val(studentId);
                            $('#gradeModal input[name="studentName"]').val(studentName);
                        ...
                        $(document).ready(function(){
                            ...
                            $.ajax({
                                url: '<?php echo site_url("teacher/addGrade"); ?>',
                                type: 'POST',
                                data: formData,
                                contentType: false,
                                processData: false,
                                ...
                                error: function(xhr, status, error) {
                                    ...
                                    $('#messages2').html('<div class="alert alert-danger">An unexpected error occurred. Please try again later.</div>');
                                }
                            });
                        });
                    });
