            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                            <h3 align="center"><b>Teacher Panel - 
                                <?php foreach($teachers as $teacher): ?>
                                    <?php if($teacher->teacher_id == $id): ?>
                        ...
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $course_count; ?></span>
                                    </h3>
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $passed_count; ?></span>
                                    </h3>
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countFailedStudents; ?></span>
                                    </h3>
