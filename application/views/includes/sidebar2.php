    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-title">Teacher Account</li>
                    <li class="<?php //if($page=='dashboard'){ echo 'active'; }?>">
                        <a href="<?php echo site_url('teacherDashboard')?>"><i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-title">Main Menu</li>
                      <li class="menu-item-has-children dropdown <?php //if($page=='result'){ echo 'active'; }?>">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i> <a href="<?php echo site_url('teacherViewStudentList')?>">List of Students</a></li>
                            <li><i class="fa fa-plus"></i> <a href="<?php echo site_url('teacherViewGradeList')?>">List of Grades</a></li>
